        ...
        <form action="{{ route('admin.roles.update', $role) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="name" value="{{ old('name', $role->name) }}" required
                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 @error('name') border-red-500 @enderror">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center space-x-2">
                                <input type="checkbox" name="permissions[]" value="{{ $perm->id }}" {{ in_array($perm->id, $rolePermissions) ? 'checked' : '' }} class="rounded">
            ...
            <div class="flex justify-end space-x-3 mt-6 pt-6 border-t border-gray-100">
                ...
                <button type="submit" class="bg-indigo-600 text-white px-5 py-2.5 rounded-lg text-sm hover:bg-indigo-700">Update Role</button>
            </div>
        </form>
    </div>
</div>
