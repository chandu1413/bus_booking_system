...
<div class="flex items-center justify-between mb-5">
    <p class="text-sm text-gray-500">{{ $roles->count() }} roles configured</p>
    <a href="{{ route('admin.roles.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm">
