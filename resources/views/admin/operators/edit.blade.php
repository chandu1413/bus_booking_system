                    ...
                    <div class="grid grid-cols-3  gap-4">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email', $operator->user->email) }}" required
                                ...
                                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 @error('email') border-red-500 @enderror"
                                readonly>
                            @error('email')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Mobile Number <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="mobile_no" required placeholder="e.g. 9876543210"
                                value="{{ old('mobile_no', $operator?->profile?->phone) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <select name="business_type" id="business_type"
                                    ...
                                    <option value="individual"
                                        {{ old('business_type', $operator->business_type) === 'individual' ? 'selected' : '' }}>
                                        Individual/Proprietor
                                    </option>
                                    <option value="company"
                                        {{ old('business_type', $operator->business_type) === 'company' ? 'selected' : '' }}>
                                        Company</option>
                                    <option value="partnership"
                                        {{ old('business_type', $operator->business_type) === 'partnership' ? 'selected' : '' }}>
                                        Partnership</option>
                                </select>
                            </div>
                            <div class="">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="text" name="bank_account_holder"
                                    value="{{ old('bank_account_holder', $operator->bank_account_holder) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="bank_account_number"
                                    value="{{ old('bank_account_number', $operator->bank_account_number) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mt-4">
                            <div>
                                ...
                                <input type="text" name="bank_name"
                                    value="{{ old('bank_name', $operator->bank_name) }}" placeholder="Bank name" required
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500">
                                @error('bank_name')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="ifsc_code"
                                    value="{{ old('ifsc_code', $operator->ifsc_code) }}" placeholder="IFSC code" required
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500">
                                @error('ifsc_code')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <x-input-file-upload name="bank_proof_file" id="bank_proof_file" :value="old('bank_proof_file', $operator->bank_proof_file)"
                                    inputClass="border p-2 w-full rounded" accept=".pdf,.jpg,.jpeg,.png" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            <div>
                                ...
                                <input type="text" name="gst_number"
                                    value="{{ old('gst_number', $operator->gst_number) }}" placeholder="GST number"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500">
                                @error('gst_number')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <x-input-file-upload name="gst_certificate" id="gst_certificate" :value="old('gst_certificate')"
                                    inputClass="border p-2 w-full rounded" accept=".pdf,.jpg,.jpeg,.png" />
                            </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <div>
                                ...
                                <x-input-file-upload name="utility_bill_file" id="utility_bill_file" :value="old('utility_bill_file')"
                                    inputClass="border p-2 w-full rounded" accept=".pdf,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="url" name="company_website"
                                    value="{{ old('company_website', $operator->company_website) }}"
                            ...
                            <div>
                                ...
                                <input type="email" name="support_email"
                                    value="{{ old('support_email', $operator->support_email) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Support Number 1 <span
                                        class="text-red-500">*</span></label>
                                <input type="tel" name="support_number_1"
                                    value="{{ old('support_number_1', $operator->support_number_1) }}"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Support Number 2 <span
                                        class="text-red-500">*</span></label>
                                <input type="tel" name="support_number_2"
                                    value="{{ old('support_number_2', $operator->support_number_2) }}"
                                    placeholder="+91 XXXXX XXXXX" required
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <x-input-file-upload name="transport_license_file" id="transport_license_file"
                                    label="Transport License" labelClass="block text-sm font-medium text-gray-700 mb-1"
                                    :value="old('transport_license_file')" inputClass="border p-2 w-full border border-gray-300 rounded-lg"
                                    accept=".pdf,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                ...
                                <input type="text" name="transport_license_number"
                                    value="{{ old('transport_license_number', $operator->transport_license_number) }}"
                            ...
                            <div class="form-group">
                                <label class="" for="status">Account Status</label>
                                <select name="status" id="status"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500">
                                    <option value="{{ $OperatorStatus::SUBMITTED }}"
                                        {{ old('status', $operator->status) === $OperatorStatus::SUBMITTED ? 'selected' : '' }}>
                                        SUBMITTED</option>
                                    <option value="{{ $OperatorStatus::PENDING }}"
                                        {{ old('status', $operator->status) === $OperatorStatus::PENDING ? 'selected' : '' }}>
                                        PENDING</option>
                                    <option value="{{ $OperatorStatus::APPROVED }}"
                                        {{ old('status', $operator->status) === $OperatorStatus::APPROVED ? 'selected' : '' }}>
                                        APPROVED</option>
                                    <option value="{{ $OperatorStatus::REJECTED }}"
                                        {{ old('status', $operator->status) === $OperatorStatus::REJECTED ? 'selected' : '' }}>
                                        REJECTED</option>
                                    <option value="{{ $OperatorStatus::SUSPENDED }}"
                                        {{ old('status', $operator->status) === $OperatorStatus::SUSPENDED ? 'selected' : '' }}>
                                        SUSPENDED</option>
                                </select>
                            </div>
                        </div>
