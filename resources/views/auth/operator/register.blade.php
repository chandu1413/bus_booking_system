...
<div class="min-h-screen bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-white">Operator Registration</h1>
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            <form method="POST" action="{{ route('operator.register') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="company_name" value="{{ old('company_name') }}" required
                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-indigo-500 @error('company_name') border-red-500 @enderror">
            ...
            <p class="text-center text-sm text-gray-600 mt-6">Already have an account? <a href="{{ route('operator.login') }}" class="text-indigo-600 font-medium hover:underline">Sign in</a></p>
        </div>
    </div>
</div>
@endsection
