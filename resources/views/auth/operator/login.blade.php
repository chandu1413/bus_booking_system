...
<div class="min-h-screen bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-white">Operator Login</h1>
            <p class="text-indigo-200 mt-1">Sign in to your workspace</p>
        </div>

        <div class="bg-white rounded-2xl shadow-2xl p-8">
            <form method="POST" action="{{ route('operator.store.login') }}">
                @csrf
                <div class="mb-5">
            ...
            <p class="text-center text-sm text-gray-600 mt-6">Don't have an account? <a href="{{ route('operator.register') }}" class="text-indigo-600 font-medium hover:underline">Create one</a></p>
        </div>
        ...
        <div class="mt-6 bg-white/10 backdrop-blur rounded-xl p-4 text-white text-sm">
            ...
            <div class="space-y-1 text-indigo-100">
                <p>🔴 operator: <code>operator@operator.com</code></p>
